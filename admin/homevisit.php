...
<head>
   ...
   <link rel="icon" href="../assets/logo.png">
   <title> <?= strtoupper($user_type) ?> | Home Visit</title>
          ...
          <div class="nav-menu">
           ...
           <!--- sub nav -->
                 ...
                 <li><a href="preapproved.php">&nbsp;&nbsp;&nbsp;Pre-Approved Application</a></li>
                    ...
                    <li class="active"><a href="homevisit.php">&nbsp;&nbsp;&nbsp;Home Visit</a></li>
...
<table >
   ...
   <?php
      if(mysqli_num_rows($res_transaction) > 0){
         ...
         ?>
            <tr>
               <td><?=$transaction_appl['id']?></td>
               <td><?=$transaction_appl['reference_no']?></td>
               ...
               <td class="sched-action"> 
                  <button class="action-button" id="adoption-send_sched" data-role="declined" data-ref_no="<?=$transaction_appl['reference_no']?>"> 
      ...
      <?php }
         ...
         <tr>
            <td colspan="7">No data fetched</td>
         </tr>
      <?php   } ?>
   </tbody>
</table>
