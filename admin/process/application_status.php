...
$qclogo = file_get_contents('../process/logo.png');
$vetlogo = file_get_contents('../process/bulacan.png');
    ...
    while($adoption_rows = mysqli_fetch_assoc($res_adoption_pending)) {
        ...
        if($adoption_rows['reference_no'] == $ref_no) {
            ...
            // echo $image_path;
                ...
                $html_content .= '<li>, Bulacan</li>';
                $html_content .= '<br><li style="font-size: 12px;">Animal Shelter and Care Facility</li>';
                $html_content .= '<span style="font-size: 12px;">Email Address: agrimarilao@yahoo.com | Tel no.: (+63) 926 431 3048</span>';
                $html_content .= '</ul>';
                $html_content .= '</div>';
                ...
                $html_content .= '<li>I give the VETERINARY DEPARTMENT (MVD) permission to call my home and to inspect the premises under which this animal is kept and if during the time of inspection, the ASCF representative believes those conditions unsuitable or finds the dog unwell and/or manifesting ill treatment whatsoever, I understand, authorize and agree that ASCF shall remove this animal from my control, without prior notice or my permission. I understand that I will not have recourse of any kind resulting from such action.</li>';
                ...
                $html_content .= '<li>I will not hold the VETERINARY DEPARTMENT, responsible for any present of future illness of this animal of for any damages which the animal may cause to any person or property. I have received Information about common diseases in animal shelters and realize that my animal may have undiagnosed medical problems or may be incubating an Infectious condition that could be contagious to my other animals. I accept responsibility for the continued veterinary care of the animal. I understand that ASCF will NOT be able to provide further assistance with diagnosis and management of this animal or any other animal in my household, but will take the animal back with questions asked.</li>';
                ...
                $html_content .= '<p style="text-indent: 30px; text-align: justify;" >This adoption Indemnification Agreement is executed by the referenced ADOPTER for and in consideration of the sum of 500.00; pursuant to SEC. 44 of the Ord. No. SP 2505 S-2016 also known as Veterinary Code. The receipt of which is hereby indemnifies and holds harmless the against any and all claims, losses, damages, liabilities, penalties, punitive damages, expenses, reasonable legal fees and cost of any kind or amount whatsoever, including any third-party claims, that may arise out from adoption Contract.</p>';
                ...
                $html_content .= '<div style="display: inline-block; margin-bottom: 10px;">F01IAC ASCF- 00</div>';
                $html_content .= '</div>';
                ...
                $html_content_page2 .= '<li>Mariao, Bulacan</li>';
                $html_content_page2 .= '<br><li style="font-size: 12px;"> Animal Shelter and Care Facility</li>';
                $html_content_page2 .= '<span style="font-size: 12px;">Email Address: agrimarilao@yahoo.com | Tel no.: (+63) 926 431 3048</span>';
                ...
                $html_content_page3 .= '<li>, Bulacan</li>';
                $html_content_page3 .= '<br><li style="font-size: 12px;">Animal Shelter and Care Facility</li>';
                $html_content_page3 .= '<span style="font-size: 12px;">Email Address: agrimarilao@yahoo.com| Tel no.: (+63) 926 431 3048</span>';
                ...
                $html_content_page4 .= '<li style="font-weight: 650; font-size: 1.25rem; margin-top: 25px; margin-bottom: 35px; font-family: Arial, sans-serif;"><strong>Animal Shelter and Care Facility </strong></li>';      
                ...
                $html_content_page4 .= '<div style="text-align: left; text-indent: 10px;">  Animal  Shelter  and Care Facility  <span style="margin-left: 165px;"> ASCF</span></div>';
                $html_content_page4 .= '</div>';
