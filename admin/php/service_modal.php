...
<div class="modal-box">
   ...
   <div class="service-info">
      <h3> Service's Details   <span> <span id="mess" style="font-size: 40px;"></span> <button id="edit-service-detail" > Edit Service </button> <button id="save-service-detail" data-se_id="<?=$service_info['id']?>" hidden> Save Edit </button></span></h3>
