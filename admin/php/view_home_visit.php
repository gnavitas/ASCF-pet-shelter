...
.form-input-disable input[type="text"]:focus,
.form-input-disable textarea:focus {
    border-color: #66afe9;
    outline: none;
}
   ...
   <div class="q-a-details">
      ...
      <div class="q-a">
         ...
         <table border="1">
            ...
            <tr>
               <td width="50%"> Have an existing pet?</td>
               <td> 
   ...
   <div class="home-visit">
      <?php if (mysqli_num_rows($ci_query) > 0) {
         ...
         <div class="adopter-detail-section" style="margin-left: 1rem; margin-right: 1rem;">
            ...
            <div class="details">
               <div class="form-input-disable">
                  <p> Is there enough space for the pet? </p>
                  <input type="text" value="<?= $ci_row['eval1']; ?>" readonly>
               </div>
               <div class="form-input-disable">
                  <p> Have a good place to sleep for the pet? </p>
                  <input type="text" value="<?= $ci_row['eval2']; ?>" readonly>
               </div>
               <div class="form-input-disable">
                  <p> Is the pet's body healthy? </p>
                  <input type="text" value="<?= $ci_row['eval3']; ?>" readonly>
               </div>
               <div class="form-input-disable">
                  <p> Have you seen the pet behave well?</p>
                  <input type="text" value="<?= $ci_row['eval4']; ?>" readonly>
               </div>
               <div class="form-input-disable">
                  <p> Has it seen good care since it was adopted?</p>
