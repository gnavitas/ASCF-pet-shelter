...
function sendEmail($email, $first_name, $last_name, $userid)
{
   ...
   $mail->setFrom('YOUR_EMAIL@gmail.com', 'Animal Shelter and Care Facility');
...
function send_temp_acc($conn, $admin_id){
    ...
    $str = file_get_contents('../../function/email/admin_temp.html');
