...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM pets WHERE 1=1"; // Start with a basic query
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            // Display pet details
            // Example: echo $row['pet_name'];
        }
    } else {
        // No pets found
        echo "No pets found matching your criteria.";
    }
...
<div class="missingPet">
            <a href="reportanimal.php">Report</a>
        </div>
  <form id="char-form">
            ...
            ?>
              <div class="pet-card">
                ...
                <div class="pet-desc">
                  ...
                  <div>
                    <a href="./adoptDetail.php?id=<?=$pet_id?>">
                    <?php echo "<img src='assets/logo.png' alt='Logo' />";?>
                    </a>
                  </div>
                </div> 
              </div>
