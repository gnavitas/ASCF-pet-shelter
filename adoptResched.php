            ...
            <div class="resched-body">
                ...
                <form id="resched" action="./function/adopt_reschedule.php?refno=<?php echo $refno; ?>" method="POST">
                    ...
                    <div class="resched-buttons">
                        ...
                        <button type="button" class="resched-btn submit-btn" id="resched-submit">Submit</button>
                    </div>
                </form>
            </div>
        </div>
...
<script> 
    ...
    const config = {
      ...
      disable: [
          rmydays,
          "<?php echo $row_sched['date_of_schedule']; ?>"
      ],
    }

    const fp = flatpickr("#new_date", config);

    document.getElementById('resched-submit').addEventListener('click', function() {
        document.getElementById('resched').submit();
    });
