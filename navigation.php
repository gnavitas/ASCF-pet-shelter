...
if (strpos($_SERVER['REQUEST_URI'], "editMyAccount") !== false || strpos($_SERVER['REQUEST_URI'], "verfemail") !== false || strpos($_SERVER['REQUEST_URI'], "verfphone") !== false) {
  ...
  if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
   ...
   <p> To avail our Services make sure your email is verified. Click here to <a href="myAccount.php" class="primary" style="color: #2c0d10;">Verify</a></p> 
   <i class="fa-solid fa-xmark fa-1x reminderClose" style="color:#2c0d10;"> </i>
 </div>';
        }
      }
    }
